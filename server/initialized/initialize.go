...
import (
	...
	"os/signal"
	"syscall"
	"zg5/Homework01/server/consul"
	"zg5/Homework01/server/global"
	"zg5/Homework01/server/logic"
...
func initConsul() consul.RegistryClient {
	...
	consulClient := consul.NewConsulClient(global.RpcALLConf.GrpcIp.Host, global.RpcALLConf.GrpcIp.Port)
...
func InitGrpc() {
	...
	zap.S().Info("端口正在监听...", global.RpcALLConf.GrpcIp.Host+":", global.RpcALLConf.GrpcIp.Port)
